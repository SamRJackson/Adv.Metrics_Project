...
```
*Signicant in sample with police data* : PctFam2Par, racepctblack, racePctHisp, pctWInvInv, PctNotHSGrad, PctEmploy, PolicPerPop, PolicBudgPerPop

*Signicant in sample without police data* : PctFam2Par, racepctblack, racePctHisp, pctWInvInc, PctNotHSGrad. 

*Overlap* : PctFam2Par, racepctblack, racePctHisp, PctWInvInc and PctNotHSGrad. I think we should keep these no matter what. 
